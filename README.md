...
![HAProxy version](https://img.shields.io/badge/HAProxy-3.4.2-blue?style=for-the-badge)
...
### ✅ Install:
    ...
    sudo dnf -y install /opt/HAProxy-3-RPM-builder/rpmbuild/RPMS/x86_64/haproxy-3.4.2-1.el9.x86_64.rpm

or, if you build *.rpm with Docker:

    sudo dnf -y install RPMS/haproxy-3.4.2-1.el9.x86_64.rpm 
